            ...
            "performAuthorizationRequest" -> {
                ...
                triggerMainActivityToHideChromeCustomTab = {
                    val notificationIntent =
                        _activity.packageManager.getLaunchIntentForPackage(_activity.packageName);
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?): Boolean {
        if (requestCode == CUSTOM_TABS_REQUEST_CODE) {
            ...
            if (_lastAuthorizationRequestResult != null) {
                _lastAuthorizationRequestResult.error(
...
public class SignInWithAppleCallback : Activity {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (lastAuthorizationRequestResult != null) {
            ...
            Log.e(
                TAG,
                "Received Sign in with Apple callback, but 'lastAuthorizationRequestResult' function was `null`"
            )
        }

        val triggerMainActivityToHideChromeCustomTab =
        ...
        if (triggerMainActivityToHideChromeCustomTab != null) {
            ...
            Log.e(
                TAG,
                "Received Sign in with Apple callback, but 'triggerMainActivityToHideChromeCustomTab' function was `null`"
            )
        }
